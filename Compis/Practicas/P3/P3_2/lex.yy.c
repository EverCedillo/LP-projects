...
YY_RULE_SETUP
#line 11 "ejemplo2.l"
{yylval.sval=( char *) realloc ( yylval.sval , yyleng * sizeof ( char )) ; strcpy ( yylval.sval , yytext ); return ID;}
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 12 "ejemplo2.l"
